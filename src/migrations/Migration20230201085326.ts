...
export class Migration20230201085326 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "product" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "bar_code" varchar(255) not null, "cooking_instruction" varchar(255) null, constraint "product_pkey" primary key ("uuid"));');
    ...
    this.addSql('create table "product_category" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, constraint "product_category_pkey" primary key ("uuid"));');
    ...
    this.addSql('create table "storage_container" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "location" varchar(255) not null, constraint "storage_container_pkey" primary key ("uuid"));');

    this.addSql('create table "pantry_item" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "product_uuid" uuid not null, "expiry_date" timestamptz(0) null, "quantity" int not null default 1, "storage_container_uuid" uuid null, constraint "pantry_item_pkey" primary key ("uuid"));');
    ...
    this.addSql('create table "user" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) null, "email" varchar(255) not null, "language" varchar(255) null default \'EN\', "password" varchar(255) not null, constraint "user_pkey" primary key ("uuid"));');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "pantry_item_categories" drop constraint "pantry_item_categories_product_category_uuid_foreign";');

    this.addSql('alter table "pantry_item" drop constraint "pantry_item_storage_container_uuid_foreign";');

    this.addSql('alter table "pantry_item_categories" drop constraint "pantry_item_categories_pantry_item_uuid_foreign";');
